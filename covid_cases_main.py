...
from us_states_per_capita import cases_per_100k
from us_states_per_capita import deaths_per_100k
...
total_cases_today = covid_us_scatter.iloc[-1] 
total_cases_today_string = str('{:,}'.format(total_cases_today)) #Insert commas every 3 digits
...
'''us_states_per_capita.py import/call function'''
states_map_cases100k = cases_per_100k()
states_map_deaths100k = deaths_per_100k()
